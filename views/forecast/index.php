<header>
    <div class="mobile-header">
        ...
        <div class="header-title">
            <h1><i class="fa-solid fa-chart-line" style="color: var(--success);"></i> Forecasting & Smart Features</h1>
            <p>Gas prediction, bazaar suggestions, calendar events, advance orders, and expenses.</p>
        </div>
    </div>
</header>
...
<div class="grid-cards">
    <div class="stat-card glass-panel">
        ...
        <?php else: ?>
            ...
            <div class="trend" style="color: var(--text-muted);">Log gas expenses to start predictions.</div>
        <?php endif; ?>
    </div>
    ...
    <div class="stat-card glass-panel">
        ...
        <h3>Smart Bazaar Prep</h3>
        <div class="value"><?= count($bazaarSuggestions); ?> Items</div>
        <div class="trend positive"><i class="fa-solid fa-chart-simple"></i> Based on 7-day average</div>
    </div>
    <?php endif; ?>
</div>
...
<div class="tab-bar" data-group="forecast">
    <button class="tab-btn active" data-tab="tab-expenses" data-group="forecast"><i class="fa-solid fa-coins"></i> Expenses</button>
    <button class="tab-btn" data-tab="tab-events" data-group="forecast"><i class="fa-solid fa-calendar-day"></i> Calendar Events</button>
    <button class="tab-btn" data-tab="tab-orders" data-group="forecast"><i class="fa-solid fa-clipboard-list"></i> Advance Orders</button>
    <button class="tab-btn" data-tab="tab-suggestions" data-group="forecast"><i class="fa-solid fa-lightbulb"></i> Bazaar Suggestions</button>
</div>
...
<div class="tab-pane active" id="tab-expenses" data-group="forecast">
    <div class="section-panel glass-panel" style="margin-bottom: 1.5rem;">
        ...
        <form data-ajax data-reload="true">
            ...
            <button type="submit" class="btn btn-primary" style="margin-top: 0.5rem;"><i class="fa-solid fa-plus"></i> Add Expense</button>
        </form>
    </div>

    <div class="section-panel glass-panel">
        <div class="section-header"><h2>All Expenses</h2></div>
        <?php if (empty($expenses)): ?>
            <div class="empty-state"><i class="fa-solid fa-coins"></i><p>No expenses recorded.</p></div>
        <?php else: ?>
        <div class="table-wrapper">
            <table class="data-table">
                <thead><tr><th>Category</th><th>Name</th><th>Total</th><th>Spread</th><th>Daily</th><th>Date</th><th></th></tr></thead>
                <tbody>
...
<div class="tab-pane" id="tab-events" data-group="forecast">
    <div class="section-panel glass-panel" style="margin-bottom: 1.5rem;">
        <div class="section-header"><h2>Add Calendar Event</h2></div>
        <form data-ajax data-reload="true">
    ...
    <div class="section-panel glass-panel">
        ...
        <?php if (empty($events)): ?>
            <div class="empty-state"><i class="fa-solid fa-calendar-day"></i><p>No events scheduled.</p></div>
        <?php else: ?>
...
<div class="tab-pane" id="tab-orders" data-group="forecast">
    <div class="section-panel glass-panel" style="margin-bottom: 1.5rem;">
        <div class="section-header"><h2>Place Advance Order</h2></div>
        <form data-ajax data-reload="true">
            ...
            <h3 style="font-size: 0.9rem; margin: 1rem 0 0.5rem;">Order Items</h3>
            ...
            <div style="margin-top: 0.75rem; display: flex; gap: 1rem;">
                <button type="button" class="btn btn-glass" onclick="addOrderItemRow()"><i class="fa-solid fa-plus"></i> Add Item</button>
                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-save"></i> Place Order</button>
            </div>
        </form>
    </div>
    ...
    <div class="section-panel glass-panel">
        ...
        <?php if (empty($orders)): ?>
            <div class="empty-state"><i class="fa-solid fa-clipboard-list"></i><p>No advance orders yet.</p></div>
        <?php else: ?>
        <div class="table-wrapper">
            <table class="data-table">
                <thead><tr><th>Delivery</th><th>Customer</th><th>Bill</th><th>Advance</th><th>Status</th><th>Actions</th></tr></thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?= $o['status'] === 'Delivered' ? 'success' : ($o['status'] === 'Cancelled' ? 'danger' : 'warning'); ?>"><?= $o['status']; ?></span>
                        </td>
                        <td style="display: flex; gap: 0.5rem;">
                            <?php if ($o['status'] === 'Pending'): ?>
                            <button class="btn btn-success btn-sm" data-action="update_order_status" data-id="<?= $o['id']; ?>" data-extra='{"status":"Delivered"}'><i class="fa-solid fa-check"></i></button>
                            <button class="btn btn-danger btn-sm" data-action="update_order_status" data-id="<?= $o['id']; ?>" data-extra='{"status":"Cancelled"}'><i class="fa-solid fa-xmark"></i></button>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
...
<div class="tab-pane" id="tab-suggestions" data-group="forecast">
    <div class="section-panel glass-panel">
        <div class="section-header"><h2>Smart Bazaar Suggestions for Tomorrow</h2></div>
        <?php if (empty($bazaarSuggestions)): ?>
            <div class="empty-state"><i class="fa-solid fa-lightbulb"></i><p>No data yet. Start logging daily stocks to get AI-powered suggestions.</p></div>
        <?php else: ?>
        <div class="table-wrapper">
            <table class="data-table">
                <thead><tr><th>Item</th><th>Suggested Prep Qty</th></tr></thead>
                <tbody>
